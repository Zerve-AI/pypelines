...
from .schemas import HyperParamsTSRegression, NumericalParamRegression, CategoricalParamTSRegression
        ...
        for k, v in params.items():
            for p in v:
                ...
                if k=='categorical':
                    ...
                    hyperparams.append(NumericalParamRegression(**{'prefix': model_prefix, **p}))
